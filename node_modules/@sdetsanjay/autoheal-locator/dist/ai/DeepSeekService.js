...
class DeepSeekService {
    constructor(apiKey, model = 'deepseek-chat', timeout = 30000) {
        this.apiKey = apiKey;
        this.model = model;
    ...
    async analyzeDOM(html, description, originalSelector, framework = AutomationFramework_1.AutomationFramework.SELENIUM) {
        ...
        try {
            ...
            console.error('DeepSeek DOM analysis failed:', error.response?.data || error.message);
    ...
    async analyzeVisual(screenshot, description) {
        ...
        try {
            ...
            console.error('DeepSeek visual analysis failed:', error.response?.data || error.message);
