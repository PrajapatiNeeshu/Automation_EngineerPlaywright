 ...
 */
class OpenAIService {
    constructor(apiKey, model = 'gpt-4o', timeout = 30000) {
        this.apiKey = apiKey;
        this.model = model;
    ...
    async analyzeDOM(html, description, originalSelector, framework = AutomationFramework_1.AutomationFramework.SELENIUM) {
        ...
        try {
            ...
            console.error('OpenAI DOM analysis failed:', error.response?.data || error.message);
    ...
    async analyzeVisual(screenshot, description) {
        ...
        try {
            ...
            console.error('OpenAI visual analysis failed:', error.response?.data || error.message);
