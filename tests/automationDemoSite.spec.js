...
test.describe('Automation Demo Site - Complete Flow', () => {
  test('Complete workflow with reCAPTCHA, alerts, and frames', async ({ page }) => {
    // Navigate to the automation demo site
    try {
      await page.goto('https://www.automationbro.com/', { waitUntil: 'domcontentloaded', timeout: 30000 });
    } catch (e) {
  ...
  test('Simplified flow - Alerts and Frames only', async ({ page }) => {
    // Navigate to the automation demo site
    try {
      await page.goto('https://www.automationbro.com/', { waitUntil: 'domcontentloaded', timeout: 30000 });
    } catch (e) {
